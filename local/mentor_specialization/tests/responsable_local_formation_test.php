...
class local_mentor_specialization_responsable_local_formation_testcase extends advanced_testcase {
    /**
     * Init $CFG
     */
    ...
    /**
     * Test of list entity user managed with role RLF
     * (managed entity is not allowed for RLF)
     *
     * @throws ReflectionException
     */
    public function test_get_managed_entities_rlf_ok() {
        ...
        \local_mentor_core\profile_api::role_assign('referentlocal', $newuser->id, $entity1->get_context());
    ...
    /**
     * Test of list training by entity with role RLF
     *
     * @throws ReflectionException
     */
    public function test_get_user_training_courses_rlf_ok() {
        global $DB;
     ...
     * @throws ReflectionException
     */
    public function test_get_user_training_courses_with_sub_entity_rlf_ok() {
        $this->resetAfterTest(true);
        $this->init_config();
        $this->reset_singletons();
        ...
        $trainingdata = $this->get_training_data('NEWTRAINING', $subentitydata);
    ...
    /**
     * Test of list session by entity with role RLF
     *
     * @throws ReflectionException
     */
    public function test_get_user_session_courses_rlf_ok() {
        $this->resetAfterTest(true);
        $this->init_config();
        $this->reset_singletons();
    ...
    /**
     * Test of list session by entity with sub entity with role RLF
     *
     * @throws ReflectionException
     */
    public function test_get_user_session_courses_with_sub_entity_rlf_ok() {
        $this->resetAfterTest(true);
        $this->init_config();
        $this->reset_singletons();
    ...
    /**
     * Test of list session by entity with sub entity with role RLF to sub entity
     *
     * @throws ReflectionException
     */
    public function test_get_user_session_courses_with_sub_entity_with_role_to_sub_entity_rlf_ok() {
        $this->resetAfterTest(true);
        $this->init_config();
        $this->reset_singletons();
