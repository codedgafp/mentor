...
define([
    ...
    var localCatalog = {
        ...
        init: function (collections) {
            ...
            // Close the collapses on small screens.
            if (window.innerWidth < 767) {
                $('.mentor-accordion .card-header').click();
            }

            var that = this;
            /*var dictonnaryHTML = encodeURIComponent($('#trainings-dictionnary').html());
            this.trainingsDictionnary = JSON.parse(decodeURIComponent(dictonnaryHTML));*/
        ...
        filterTrainings: function (
            ...
            var trainings = JSON.parse($('#available-trainings').html());
        ...
        updateFilters: function (trainings) {
            ...
            $(collections).each(function () {
                ...
                $('#collections').append('<button data-type="collections" data-identifier="' + this.name + '" ' + selected + '>' + this.name + '<span class="nbresults">(' + this.nbresults + ')</span>' + cross + '</button>');
            });
            ...
            $(entities).each(function () {
                ...
                $('#entities').append('<button data-type="entities" data-identifier="' + this.id + '" ' + selected + '>' + this.name + '<span class="nbresults">(' + this.nbresults + ')</span>' + cross + '</button>');
            });
         ...
         *
         * @param $element the jquery button element
         */
