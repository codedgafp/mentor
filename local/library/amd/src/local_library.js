...
], function ($, ui, format_edadmin, mentor, cookie) {
    var local_library = {
        /**
         * Init JS
        ...
        initIntroductionLibrary: function () {
            ...
            $('#header-library .show-less').click(function (e) {
         ...
         *
         * @param {string} trainingCourseUrl
         */
        publicationSuccess: function (trainingCourseUrl) {
            ...
            mentor.dialog(
                ...
                '</p>',
                {
                    ...
                    close: function () {
                        window.location.href = trainingCourseUrl;
                    },
                    buttons: [{
